    ...
    <div class="flex flex-col gap-3">
        ...
        <div class=" flex flex-col gap-2" v-else>
            ...
            <NuxtLink :to="`/Coupon/code/${coupon.couponCode}`"
                class=" hover:bg-red-900 shadow-md w-full flex p-3 rounded-md gap-2 hover:text-white" v-for="coupon in coupons"
                :key="coupon.couponId">
...
const { data, pending, error } = await useLazyFetch<Response & { result: CouponResponse[] }>(
    () => `${config.public.apiBase}/api/CouponAPI`
)
